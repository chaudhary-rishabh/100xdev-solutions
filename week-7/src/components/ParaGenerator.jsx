    ...
    return (
        <div style={{ height: "100vh", width: "100vw" }}>
            ...
            <form onSubmit={generatePara} style={{margin:"auto", display:"flex", alignItems:"center", justifyContent:"center"}}>
                <input style={{border:"1px solid black", padding:"10px"}} type="number" min={1} onChange={e => setText(e.target.value)} value={text} placeholder='Enter Number of Words' required />
